...
public class CalcSimulation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 550, 330, 50));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 510, 120, 20));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 102, 51));
        jLabel3.setText("Algorithm: ");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 110, 30));

        algoSelected2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        algoSelected2.setForeground(new java.awt.Color(255, 102, 51));
        algoSelected2.setText("CPU:");
        jPanel1.add(algoSelected2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 70, 30));

        selectedAlgo.setBackground(new java.awt.Color(204, 204, 204));
        selectedAlgo.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        selectedAlgo.setForeground(new java.awt.Color(255, 102, 51));
        selectedAlgo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                selectedAlgoActionPerformed(evt);
            }
        });
        jPanel1.add(selectedAlgo, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 30, 240, 30));
        ...
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 20, 130, 30));
        ...
        avgServeLabel.setForeground(new java.awt.Color(255, 102, 51));
        ...
        selectedJob.setBackground(new java.awt.Color(204, 204, 204));
        selectedJob.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        selectedJob.setForeground(new java.awt.Color(255, 102, 51));
        selectedJob.setText("P1");
        jPanel1.add(selectedJob, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 70, 110, 30));

        avgWaitField.setBackground(new java.awt.Color(204, 204, 204));
        avgWaitField.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        avgWaitField.setForeground(new java.awt.Color(255, 102, 51));
        jPanel1.add(avgWaitField, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 210, 80, 30));

        avgServeField.setBackground(new java.awt.Color(204, 204, 204));
        avgServeField.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        avgServeField.setForeground(new java.awt.Color(255, 102, 51));
        jPanel1.add(avgServeField, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 270, 80, 30));

        totalExecField.setBackground(new java.awt.Color(204, 204, 204));
        totalExecField.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        totalExecField.setForeground(new java.awt.Color(255, 102, 51));
        ...
        avgTurnLabel1.setForeground(new java.awt.Color(255, 102, 51));
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 400, 30, 20));
